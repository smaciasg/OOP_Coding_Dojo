...
class Usuario:
    ...
    def __init__(self,name, identificador_usuario):
        ...
        self.cuenta_bancaria = Cuenta_Bancaria("CB3",0,0)
    ...
    def ver_info_cuentas_usuarios(cls,id_usuario=""):
        print(cls.info_cuentas_usuarios[0].cuenta_bancaria.nombre_cuenta)
    #     contador = 0
...
cliente1.cuenta_bancaria = Cuenta_Bancaria("CB1",2,100)
cliente1.cuenta_bancaria = Cuenta_Bancaria("CB2",5,500)
